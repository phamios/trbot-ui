...
import { Children, FC, forwardRef, HTMLAttributes, ReactElement, ReactNode, useState } from 'react';
...
CardLabel.propTypes = {
	...
	iconColor: PropTypes.oneOf([null, 'primary', 'secondary', 'success', 'info', 'warning', 'danger', 'light', 'dark']),
	pre: PropTypes.node,
};
...
export const CardTitle = forwardRef<HTMLDivElement, ICardTitleProps>(({ tag, className, children, ...props }, ref) => {
	return (
		<TagWrapper
			ref={ref}
			tag={tag}
...
Card.propTypes = {
	...
	tabButtonColor: PropTypes.oneOf(['primary', 'secondary', 'success', 'info', 'warning', 'danger', 'light', 'dark']),
